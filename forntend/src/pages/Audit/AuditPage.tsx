...
export const AuditPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    async function loadAuditLogs() {
      try {
        const res = await auditService.getAuditEvents();
    ...
    <div className="p-margin-page flex flex-col gap-margin-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
        <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-panel-padding flex flex-col gap-1 shadow-sm">
          ...
          <span className="font-section-heading text-2xl font-bold text-primary">{events.length + 24800}</span>
              ...
              {isLoading ? (
                <tr>
                  <td colSpan={5} className="p-8 text-center text-outline">
                    ...
                    <span>Loading audit log from backend...</span>
                  </td>
                </tr>
              ) : (
